...
public class LayoutVisitor implements Visitor {
  ...
  private Polyline bridge (Polyline line1, int x1, int y1,
    ...
    public Object visitRepeatDoUntilCommand(RepeatDoUntilAST aThis, Object o) {
        ...
        return(layoutBinary("Repeat Command", aThis.C, aThis.DoUntil));
        
    }    
    
    @Override
    public Object visitForBecomesCommand(ForBecomesCommand aThis, Object o) {
        return(layoutBinary("For Becomes Command", aThis.I, aThis.E));
    }    
    ...
    public Object visitRepeatForWhile(RepeatForWhile aThis, Object o) {
        if(aThis.I == null){
            return(layoutTernary("Repeat Command",aThis.ForBecomes, aThis.E, aThis.whileC));
        }
        else{
            return(layoutQuaternary("Repeat Command",aThis.I, aThis.ForBecomes, aThis.E, aThis.whileC));
        }
    }
    ...
    public Object visitRepeatForUntil(RepeatForUntil aThis, Object o) {
        if(aThis.I == null){
            return(layoutTernary("Repeat Command",aThis.ForBecomes, aThis.E, aThis.UntilC));
        }
        else{
            return(layoutQuaternary("Repeat Command",aThis.I, aThis.ForBecomes, aThis.E, aThis.UntilC));
        }
    }
